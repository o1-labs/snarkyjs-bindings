...
export function wasmfporacles_new(a: number, b: number, c: number, d: number, e: number): number;
...
export function wasmfqoracles_new(a: number, b: number, c: number, d: number, e: number): number;
...
export function wasmfpplonkverifierindex_new(a: number, b: number, c: number, d: number, e: number, f: number, g: number): number;
...
export function wasmfqplonkverifierindex_new(a: number, b: number, c: number, d: number, e: number, f: number, g: number): number;
